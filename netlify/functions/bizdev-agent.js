...
exports.handler = async function() {
  ...
  try {
    ...
    const messages = [{
      role: 'user',
      content: `Run your weekly business development analysis. Today is ${today}. Use get_conversion_funnel, get_stalled_leads, get_rep_performance, and get_referral_pipeline to gather all the data you need.`
    }];
