...
exports.handler = async function(event) {
  ...
  try {
    ...
    const [all, stalled, spend, agentReports] = await Promise.all([
      supaGet('/customers?select=id,first_name,last_name,phone,lead_category,sold_type,step,solar_status,lead_source,rep_id,setter_name,invoice_amount,deposit_status,assigned_ops,lead_temp,created_at,address&limit=2000', key),
