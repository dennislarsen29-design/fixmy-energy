-- Axia/QCells PPW commission formula (2026-08-29, per Dennis): Base PPW − (Redline −
-- Domestic Content Bonus) = Net PPW, × System Size (Watts) = Gross Commission. These
-- three fields are entered manually per job on the Axia/QCells accounting panel, the
