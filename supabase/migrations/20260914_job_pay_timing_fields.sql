...
--                   QCell alike). Stamped once, never overwritten, by every save
...
--   ns_pto_at     — Axia/QCell's real completion timestamp, stamped the moment
...
-- "estimated install date" seed (35 days for battery_retrofit and Axia/QCell, 10
