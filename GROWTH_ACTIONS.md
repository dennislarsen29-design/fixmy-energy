...
- ⏳ **Search Console** — ✅ verified + sitemap submitted 2026-07-04 (signed in under the "E" Google account). Still open: (a) ☰ → Security & Manual Actions → *Manual actions* — screenshot the verdict for Claude; (b) ☰ → *Performance* → stretch to 12–16 months, screenshot the traffic curve; (c) Settings → Users and permissions → add main Google account as Owner.
